...
class store
{
	...
	//to view product
	private void displayProduct() throws FileNotFoundException {
		String desc,id, qty, value, stock, s = null;
		String cline[]=new String[5];
		...
		while(true)
		{
			...
			System.out.println(id+"   "+desc+"            "+qty+"         " +"    "+stock);
		}
	}
